...
var file_arithmetic_svc_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x1a, 0x14, 0x6e, 0x75, 0x6d, 0x62,
	...
	0x70, 0x62, 0x2e, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x22, 0x00, 0x12, 0x3a, 0x0a, 0x11, 0x47,
	0x65, 0x74, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
...
var file_arithmetic_svc_proto_depIdxs = []int32{
	...
	0, // 2: pb.ArithmeticService.GetDivision:input_type -> pb.OperationParameters
	0, // 3: pb.ArithmeticService.GetMultiplication:input_type -> pb.OperationParameters
	1, // 4: pb.ArithmeticService.GetAddition:output_type -> pb.Answer
	1, // 5: pb.ArithmeticService.GetSubtraction:output_type -> pb.Answer
	1, // 6: pb.ArithmeticService.GetDivision:output_type -> pb.Answer
	1, // 7: pb.ArithmeticService.GetMultiplication:output_type -> pb.Answer
...
func file_arithmetic_svc_proto_init() {
	...
	file_number_message_proto_init()
	type x struct{}
